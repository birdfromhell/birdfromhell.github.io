...
function switchDarkLightMode() {
    ...
    // mengecek apakah sistem pengguna keinginan pengguna
    // mengatur browsernya untuk menampilkan 'dark mode'
    if (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches) {
        switchToDarkMode();
    }
    // 'light mode' dipilih jik tidak ada preferensi atau sistem tidak mendukung pilihan ini
    else {
        switchToLightMode();
    }

    icon.onclick = () => {
        // jika saat ini adalah mode dark, maka ubah ke mode light dan sebaliknya
    ...
    function switchToDarkMode() {
        ...
        // ganti gambar saat mouseover dan mouseout
